...
class Order extends Api
{
    ...
    public function place_order(){
        ...
        $data=['user_id'=>$user_id,'name'=>$name,'phone'=>$phone,'product_type'=>$product_type,'form_image'=>$form_image,'drawing_image'=>$drawing_image,'ordersn'=>$order_sn,'classification'=>$classification,'create_time'=>$create_time];

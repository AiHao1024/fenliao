            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'form_image', title: __('Form_image'), events: Table.api.events.image, formatter: Table.api.formatter.image},
                        {field: 'drawing_image', title: __('Drawing_image'), events: Table.api.events.image, formatter: Table.api.formatter.image},
                        ...
                        {field: 'classification', title: __('Classification'), searchList: {"prouuct":__('Prouuct'),"sample":__('Sample')}, formatter: Table.api.formatter.normal},
